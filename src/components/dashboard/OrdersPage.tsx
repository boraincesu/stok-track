          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {filteredOrders.map((order) => (
                ...
                >
                  <td className="p-4 font-medium text-primary hover:underline cursor-pointer">
                    {order.id}
                  </td>
                  ...
                  <td className="p-4 text-sm font-bold text-text-light-primary dark:text-dark-primary">
